    ...
    if (event is LoginEmailChanged) {
      ...
      try {
        ...
        if (result != null) {
          ...
          emit(state.copyWith(
              formStatus: SubmissionFailedState(errorMessage: 'adsasd')));
        }
      } catch (e) {
        emit(state.copyWith(
            formStatus: SubmissionFailedState(errorMessage: e.toString())));
      }
      ...
      emit(state.copyWith(
          formStatus: SubmissionFailedState(errorMessage: event.message)));
    }
  }
}
